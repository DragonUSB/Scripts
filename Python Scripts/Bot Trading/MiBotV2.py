...
datos = pd.read_csv('Scripts/Python Scripts/' + f_tick + tick + '_1d.csv', sep = ",")
...
for idx, row in df_test.iterrows():
    ...
    if row['side'] == 0:
        ...
        f_unidades_acumuladas = initial_position
        precio_anterior = backtest[-1][3]
        ...
        f_unidades = f_unidades_acumuladas
