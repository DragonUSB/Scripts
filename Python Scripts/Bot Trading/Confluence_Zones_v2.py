...
histogram_bool = ((datos['histogram'] > datos['histogram'].shift(1)) & (datos['histogram'] >= 0)) | ((datos['histogram'] < datos['histogram'].shift(1)) & (datos['histogram'] <= 0))
print(histogram_bool.value_counts())
print(len(histogram_bool))
long_signals = ((histogram_bool == True) & (histogram_bool.shift(1) == False) & (histogram_bool.shift(2) == False) & (datos['histogram'] >= 0)) | (
                (histogram_bool == True) & (histogram_bool.shift(2) == False) & (histogram_bool.shift(1) == False) & (datos['histogram'] <= 0))
short_signals = (datos['is_bullish'].shift(1) == True) & (datos['is_bullish'] == False) & (histogram_bool == False)
