...
datos['mv10'] = sma(datos.Close, 10)
# datos['mv10'].plot()
datos['mv20'] = sma(datos.Close, 20)
# datos['mv20'].plot()

datos.head(30)

columnas = ['Close', 'mv10', 'mv20']
...
datos['alpha'] = datos['mv10'] - datos['mv20']
# datos['alpha'].plot()
...
datos['alpha_trade_compra'] = np.where(datos['alpha_trade_long'] == True, datos['mv10'], np.nan)
datos['alpha_trade_venta'] = np.where(datos['alpha_trade_short'] == True, datos['mv10'], np.nan)
...
columnas = ['mv10', 'mv20', 'alpha_trade_compra', 'alpha_trade_venta']
...
ap0 = [ mpf.make_addplot(datos['mv10'], color = 'g'),  # uses panel 0 by default
        mpf.make_addplot(datos['mv20'], color = 'b'),  # uses panel 0 by default
      ]
...
ap1 = [ mpf.make_addplot(datos1['mv10'], color = 'g'),  # uses panel 0 by default
        mpf.make_addplot(datos1['mv20'], color = 'b'),  # uses panel 0 by default
      ]
...
plt.plot(df_test.index, df_test.mv10)
plt.plot(df_test.index, df_test.mv20)
...
plt.plot(datos.index, datos.mv10)
plt.plot(datos.index, datos.mv20)
plt.scatter(x = df_test.index, y = df_test["Buy_Signal"], marker = '^')
plt.scatter(x = df_test.index, y = df_test["Sell_Signal"], marker = 'v')
...
plt.plot(datos1.index, datos1.mv10)
plt.plot(datos1.index, datos1.mv20)
