...
while True:
    ...
    area_pts = np.array([[330, 51], [frame.shape[1]-80, 51], [frame.shape[1]-80, 326], [330, 326]])
    ...
    for cnt in cnts:
        if cv2.contourArea(cnt) > 1500:
            ...
            if 440 < (x + w) < 460:
                ...
                cv2.line(frame, (450, 0), (450, 371), (0, 255, 0), 3)

    # Visualización del conteo de autos
    cv2.drawContours(frame, [area_pts], -1, (255, 0, 255), 2)
    cv2.line(frame, (450, 0), (450, 371), (0, 255, 255), 1)
