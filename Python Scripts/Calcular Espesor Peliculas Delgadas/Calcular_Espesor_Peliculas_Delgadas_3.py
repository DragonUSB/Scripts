...
# Carga de datos
sustrato = pd.read_csv('Calcular Espesor Peliculas Delgadas\Sustrato.csv', sep = ",", header = 0)
datos = pd.read_csv('Calcular Espesor Peliculas Delgadas\Germanio E1EBE 5min N2 (200nm-2500nm).csv', sep = ",", header = 0)

sustrato_x = sustrato['Wavelength(nm)']
sustrato_y = sustrato['Transmission(%)'] / 100
...
u_p = lagrange(u_x, u_y)
l_p = lagrange(l_x, l_y)
...
plt.title('Grafica de la Pelicula Germanio N1')
...
tabla1 = PrettyTable()
tabla1.field_names = ['W (nm)', 'n_s', 'n_p_1', 'd_p_1', 'm_p_1']
for k in range(0, len(u_l_x)):
    tabla1.add_row([peaks_x[k], n_s[k], n_p_1[k], d_p_1[k], m_p_1[k]])
tabla1.float_format['W (nm)'] = ".2"
tabla1.float_format['n_s'] = ".2"
tabla1.float_format['n_p_1'] = ".2"
tabla1.float_format['n_p_2'] = ".2"
tabla1.float_format['d_p_1'] = ".2"
tabla1.float_format['d_p_2'] = ".2"
tabla1.float_format['m_p_1'] = ".2"
tabla1.float_format['m_p_2'] = ".2"
print(tabla1)
print('distancia promedio de la pelicula = ' + str(d_prom_1))
print()
tabla2 = PrettyTable()
tabla2.field_names = ['W (nm)', 'n_s', 'n_p_2', 'd_p_2', 'm_p_2']
for k in range(0, len(u_l_x)):
    tabla2.add_row([peaks_x[k], n_s[k], n_p_2[k], d_p_2[k], m_p_2[k]])
tabla2.float_format['W (nm)'] = ".2"
tabla2.float_format['n_s'] = ".2"
tabla2.float_format['n_p_1'] = ".2"
tabla2.float_format['n_p_2'] = ".2"
tabla2.float_format['d_p_1'] = ".2"
tabla2.float_format['d_p_2'] = ".2"
tabla2.float_format['m_p_1'] = ".2"
tabla2.float_format['m_p_2'] = ".2"
print(tabla2)
