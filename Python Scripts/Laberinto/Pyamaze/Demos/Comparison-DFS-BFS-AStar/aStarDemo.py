...
sys.path.append('Scripts\Python Scripts\Laberinto\Pyamaze\pyamaze')
...
if __name__=='__main__':
    m=maze(4,4)
    m.CreateMaze(loadMaze='Scripts\Python Scripts\Laberinto\Pyamaze\Demos\A-Star\stardemo.csv')
