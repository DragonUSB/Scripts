...
if __name__ == '__main__':
    S = []
    for i, Z in enumerate(build_maze((32, 32))):
        S.append(Z)

    fig = plt.figure(figsize=(10, 5))
    ax = fig.add_axes([0.0, 0.0, 1.0, 1.0], frameon=False, aspect=1)
    im = ax.imshow(S[-1], cmap=plt.cm.gray_r,
    ...
    animation.save('Scripts/Python Scripts/Laberinto/maze-build.mp4', fps=40, dpi=80, bitrate=-1,
