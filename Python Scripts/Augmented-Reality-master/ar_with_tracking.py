...
if __name__ == '__main__':
	obj = three_d_object('Augmented-Reality-master/data/3d_objects/low-poly-fox-by-pixelmannen.obj', 'Augmented-Reality-master/data/3d_objects/texture.png')
	marker_colored = cv2.imread('Augmented-Reality-master/data/m1.png')
