...
class MazePlot:
	...
	def save_as_image(self):
		plt.savefig('Scripts\Python Scripts\mazes-master\{}.png'.format(self.maze_name))
		return
	...
	def animate(self):
		...
		anim.save('Scripts\Python Scripts\mazes-master\{}.mp4'.format(self.maze_name), writer=writer)
		return
